...
public class seleniumCommon {
	public final static String defaultPath = FileSystemView.getFileSystemView().getHomeDirectory().getPath()+"\\chabad\\";
	...
	public static void openToNewTab(WebElement element,WebDriver driver, String tabUrl) throws InterruptedException {
		clickAndWait(element);
		switchTab(driver,tabUrl);
	}
	public static void switchTab(WebDriver driver, String tabUrl){
		for (String winHandle : driver.getWindowHandles()) {

			driver.switchTo().window(winHandle);
			String now_pdfUrl = driver.getCurrentUrl();
			if (now_pdfUrl.contains(tabUrl)) {
				break;
			}
		}
	}
